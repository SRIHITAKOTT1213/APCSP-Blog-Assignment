...
<span class="c1"># It only prints the number in ascending order</span>
<span class="c1"># It prints the duplicate values only once</span>

<span class="c1"># Why do you think Sets are in the same tech talk as Hashmaps/Hashtables?</span>
<span class="c1"># Maybe because It looks for only one value? </span>
<span class="c1"># And eliminates duplicates (dictionaries also can&#39;t have duplicates)</span>
</pre></div>
...
<span class="c1"># List, Integers, String</span>
...
<span class="c1"># Remove the second Taylor Swift</span>
<span class="c1"># Or use a &quot;set&quot; so it removes duplicates</span>
...
<span class="c1"># .items and can return two values</span>
<span class="c1">#</span>
</pre></div>
