...
toc: true
comments: true
nb_path: _notebooks/2022-10-09-Python-Error-Check.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-10-09-Python-Error-Check.ipynb
-->
...
<span class="k">if</span> <span class="n">item</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">menu</span><span class="p">:</span>
